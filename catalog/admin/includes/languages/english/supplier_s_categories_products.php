...
define('TEXT_INFO_COPY_TO_INTRO', 'Choose a new category you wish to copy this product to shitface');
...
define('TEXT_DELETE_CATEGORY_INTRO', 'STOP! What are you doing? Are you sure you want to delete this category?');
define('TEXT_DELETE_PRODUCT_INTRO', 'STOP! What are you doing? Are you sure you want to permanently delete this product?');
...
define('TEXT_PRODUCTS_INFO', 'Products short Info:');
...
define('TEXT_NEW_IMAGES_INTRO', 'Additional images for this products. If popup image same as new image, leave popup image blank!');    
define('TEXT_DEL_IMAGES_INTRO', 'Delete additional image for this product');    
define('TEXT_PRODUCTS_IMAGES_NEW', 'New Image');    
define('TEXT_PRODUCTS_IMAGES_NEWPOP', 'Popup Image');    
...
// End Suppliers
 //Addition from Admin Sort by products_model
define('TABLE_HEADING_PRODUCTS_MODEL', 'Model');
define('BOX_HEADING_SUPPLIER_LOGOUT','<br />Logout');
?>
