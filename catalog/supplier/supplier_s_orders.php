...
<!-- header //-->
<?php
 require('includes/header_supplier.php');
?>
<!-- header_eof //-->
      ...
      <tr>
        <td><table border="0" cellspacing="0" cellpadding="2">
          <tr>
            ...
            <td valign="top"><?php echo tep_sup_image_submit('button_update.gif', IMAGE_UPDATE); ?></td>
          </tr>
        </table></td>
      </form></tr>
      <tr>
...
<?php
  ...
  switch ($action) {
    case 'delete':
      ...
      $contents[] = array('align' => 'center', 'text' => '<br>' . tep_sup_image_submit('button_delete.gif', IMAGE_DELETE) . ' <a href="' . tep_href_link(FILENAME_ORDERS, tep_get_all_get_params(array('oID', 'action')) . 'oID=' . $oInfo->orders_id) . '">' . tep_image_button('button_cancel.gif', IMAGE_CANCEL) . '</a>');
      break;
    default:
